...
public class ConsoleView {
    ...
    public int getIntInput(String prompt) {
        ...
        while (!isValid && attempts < MAX_ATTEMPTS) {
            ...
            try {
                ...
                attempts++;
                System.out.println("Ошибка: введите число. Осталось попыток: " + (MAX_ATTEMPTS - attempts));
            }
        }
    ...
    public boolean getBooleanInput(String prompt) {
        ...
        while (!isValid && attempts < MAX_ATTEMPTS) {
            ...
            if (input.equals("да") || input.equals("yes") || input.equals("y")) {
                ...
                attempts++;
                System.out.println("Ошибка: введите да или нет. Осталось попыток: " + (MAX_ATTEMPTS - attempts));
            }
        }
    ...
    public Long selectVehicleId(List<Vehicle> vehicles) {
        ...
        return getLongInput("Введите ID автомобиля: ");
    }
    ...
    public Long selectCustomerId(List<Customer> customers) {
        ...
        return getLongInput("Введите ID покупателя: ");
    }
